document.addEventListener("DOMContentLoaded", () => {
  ...
  const blocks = [
    [
      ...
      "",
      "> foreword:",
      "I’m becoming too familiar with watching the sun rise, only to crash into sleep halfway through the day. My brain won’t switch off; it loops fears, thoughts, and occasional nonsense that doesn’t deserve this much attention.",
    ...
    [
      ...
      "<br/><br/>",
      "Instead, Reform UK invests in a large scale culture war which paints trans people and migrants as threats to women’s safety. The narrative is dishonest, and it is actively dangerous. The framing suggests that gender minorities or new arrivals are inherently suspect, when in reality the data paints a very different picture. According to the UK’s Office for National Statistics, across all sexual offences against women:<br/>",
      "• 15% of offenders were strangers<br/>",
      "• 36% were acquaintances<br/>",
      "• 22% were current or ex-intimate partners<br/>",
      "• 19% were other family members<br/><br/>",
      "Looking just at rape:<br/>",
      "• 8% committed by strangers<br/>",
      "• 46% by current or former partners<br/>",
      "• 26% by acquaintances<br/><br/>",
  ...
  function loadBlock() {
    if (i < blocks.length) {
      terminal.innerHTML += blocks[i] + "<br/><br/>";
      i++;
      setTimeout(loadBlock, 1200); 
    }
  }
