document.addEventListener("DOMContentLoaded", () => {
  ...
  const blocks = [
    ...
    [
      "Right-wing messaging constantly coats itself with the claim that it is in <i>“defence of women and children.”</i> But for Reform UK and Nigel Farage, it is clear that this is only used as a...",
      "",
      "On abortion, Nigel Farage has called the UK’s 24-week abortion limit “utterly ludicrous,” not a neutral comment, but a statement signalling rollback. Then, when the House voted to decrimi...",
      ...
      "",
      "On asylum seekers, Reform laid out a plan to deport men, women and children to Taliban-controlled Afghanistan, which for those who don’t know, is a regime notorious for denying girls and wome...",
    ...
    [
      "Instead, Reform UK invests in a large scale culture war which paints trans people and migrants as threats to women’s safety. The narrative is dishonest, and it is actively dangerous. The fram...",
      "",
    ...
    [
      ...
      "",
      "This means that about nine in ten cases of sexual violence are committed by someone the victim already knows, not by migrants or trans people scapegoated in political campaigns. This, of course...",
    ],
    [
      "And while this culture war is pushed to the headlines, the deeper failures of the British state persist. 4.5 million children in the UK live in poverty. That’s one in three kids which is a ge...",
      ...
      "",
      "The issues are far deeper than just policy and rhetoric. At its core, Reform elevates dangerous, racist and misogynistic candidates. This is beyond an issue of manifesto and policy, but an issu...",
      "",
    ],
    [
      "Nigel Farage himself set a worrying tone in June 2024 when he described Andrew Tate as an “important voice” for young men “feeling they aren’t allowed to be blokes,” even as Tate face...",
      ...
      "",
      "Closer to home, James McMurdock, Reform’s MP for South Basildon & East Thurrock, was revealed to have a 2006 conviction for assaulting his ex-girlfriend, resulting in 21 days in a young offen...",
    ...
    [
      "And from inside the ranks came another red flag: Georgie David, Reform’s candidate for West Ham & Beckton, quit the party in July 2024, stating she could not “be directly associated” with...",
    ...
    [
      "",
      "TL;DR",
      "If Reform UK and Nigel Farage actually cared for women and children, they would invest in maternity protections, robust sex and consent education, mental health support, and poverty reduction. ...",
      "",
      "Instead, they offer abortion rollbacks, plans to deport women and children to Taliban-controlled Afghanistan, tolerance of candidates with histories of misogyny and violence, and endless flag-w...",
      "",
